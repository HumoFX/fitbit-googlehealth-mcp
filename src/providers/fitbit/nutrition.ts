...
export async function deleteFoodLog(client: FitbitClient, logId: LogId): Promise<void> {
...
export async function deleteWaterLog(client: FitbitClient, logId: LogId): Promise<void> {
  await client.requestText({
